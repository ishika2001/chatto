                ...
                <Menu>
                    <Menu.Button className="group relative w-10 h-10 rounded-full transition-shadow ui-open:shadow-[0_0_0_0.25rem_#0084FF]">
                        <Image
                            ...
                            alt="Avatar"
                        />
                        <div className="absolute -right-0.75 -bottom-0.75 w-4.5 h-4.5 bg-primary-2 rounded-full border-4 border-n-1 "></div>
                    </Menu.Button>
                    <Transition
                    ...
                    >
                        <Menu.Items className="absolute top-full -right-5 w-[19.88rem] mt-[0.9375rem] p-4 bg-n-1 border border-n-2 rounded-2xl shadow-[0px_48px_64px_-16px_rgba(0,0,0,0.25)] md:-right-38 md:w-[calc(100vw-4rem)] ">
                            <div className="flex items-center mb-3">
                                <div className="relative w-15 h-15">
                                    <Image
                                        ...
                                        src="/images/avatar.jpg"
                                        alt="Avatar"/>
                                    <div className="absolute right-0 bottom-0 w-4.5 h-4.5 bg-primary-2 rounded-full border-4 border-n-1 "></div>
                                </div>
                                <div className="pl-4">
                            ...
                            <div className="px-4 bg-n-2 rounded-xl ">
                                {menu.map((item, index) => (
                                    <Menu.Item key={index}>
                                        <button
